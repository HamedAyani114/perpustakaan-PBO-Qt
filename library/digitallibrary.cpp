...
void digitalLibrary::connectDB()
{
    ...
    QString bookTable{"CREATE TABLE IF NOT EXISTS books"
                      "(ID INTEGER PRIMARY KEY, ISBN VARCHAR(20), name VARCHAR(40),"
                      "author VARCHAR(20), genre VARCHAR(20), quantity INT,"
                      "publisher VARCHAR(20), location VARCHAR(40), date VARCHAR(10),"
...
void digitalLibrary::on_logoutButton_clicked()
{
    close();
}
